  ...
  return (
    <TwoColSection id="home">
      <div className="order-2 md:order-1">
        ...
        {/* mobile */}
        <h2 className="md:hidden text-3xl font-extrabold mb-2">Full Stack Developer</h2>
        <p className="my-2 md:my-5">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima veritatis corrupti nostrum
          repudiandae sapiente, rem asperiores impedit maiores ut deserunt similique quam rerum,
          assumenda est excepturi placeat voluptatum obcaecati sed.{' '}
        </p>
